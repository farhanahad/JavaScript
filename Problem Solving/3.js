...
function paperRequirements (q1,q2,q3){
    ...
    const totalPage1=q1*firstBookPage;
    const totalPage2=q2*secondBookPage;
    const totalPage3=q3*thirdBookPage;
    
    const totalPage= totalPage1 + totalPage2 + totalPage3;

    return totalPage;
    
}
let result= paperRequirements(1,1,1);
console.log(result);